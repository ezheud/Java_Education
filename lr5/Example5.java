...
public class Example5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Без аргументов: " + limitedValue1.getValue()); // Вывод: 0

        limitedValue1.setValue(150); // Установка значения больше 100
        System.out.println("Значение больше 100: " + limitedValue1.getValue()); // Вывод: 100

        limitedValue1.setValue(75); // Установка значения меньше 100
        System.out.println("Значение менее 100: " + limitedValue1.getValue()); // Вывод: 75

        Example5 limitedValue2 = new Example5(50); // Использование конструктора с аргументом
        System.out.println("С аргументом: " + limitedValue2.getValue()); // Вывод: 50

        limitedValue2.setValue(); // Установка значения по умолчанию (0)
        System.out.println("Дефолт значение: " + limitedValue2.getValue()); // Вывод: 0
    }
}